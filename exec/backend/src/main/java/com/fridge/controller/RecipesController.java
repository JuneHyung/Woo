...
public class RecipesController {
	...
	@Operation(summary = "레시피 번호로 주재료를 조회", description = "레시피 번호로 주재료를 조회하여 이름을 list 반환한다.") 
	...
	@Operation(summary = "레시피 번호로 부재료를 조회", description = "레시피 번호로 부재료를 조회하여 이름을 list 반환한다.") 
	@GetMapping("/recipeSub/{recipeId}")
	public ResponseEntity<Map<String, Object>> recipeSub(@PathVariable("recipeId") int recipeId){
		Map<String, Object> resultMap = new HashMap<>();
		HttpStatus status = null;
